...
def creat_label():
    FEC_dataset_path = 'data/FEC_dataset/faceexp-comparison-data-train-public-downloaded_after_download.csv'
    ...
    new_data.to_csv('data/labels.csv', index=None, header=None)
